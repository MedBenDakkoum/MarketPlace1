    ...
    <main className='main-container'>
        ...
        <div className='multi-choice-container'> 
                    <div className='multi-choice-navbar'>
                        <div name="default" className={classes.default} onClick={handleInterChange}>
                            Default
                        </div>
                        <div name="approval" className={classes.approval} onClick={handleInterChange}>
                            Approval
                        </div>
                        <div name="commission" className={classes.commission} onClick={handleInterChange}>
                            Commission
                        </div>

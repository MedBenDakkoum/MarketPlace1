    ...
    return (
            ...
            <div className='seller-edit-container'> 
                    <div className='seller-edit-navbar'>
                        <div className="single-section active">
                            Information
                        </div>
            ...
            <CForm className="row g-3" onSubmit={handleSubmit}>
                ...
                <CCol md={3}>
                    <Multiselect
                                    ...
                                    onRemove={removeCategorie}
                     />
                </CCol>
                <CCol md={3}>
                    <Switch onChange={handleChangeOfStoreIsPublic} checked={store.isPublic} />
                </CCol>
                <CCol md={6}>
                    <CFormInput name="email" onChange={handleChangeData} type="email" value={data.email} id="inputEmail4" label="Email" />
                </CCol>
                <CCol md={6}>
                    <CFormInput name="password" onChange={handleChangeData} type="password" id="inputPassword4" label="Password" />
                </CCol>
                <CCol xs={12}>
                    <CFormInput name="line1" onChange={handleChangeAddress} id="inputAddress" value={address.line1} label="Address" placeholder="1234 Main St"/>
                </CCol>
                <CCol xs={12}>
